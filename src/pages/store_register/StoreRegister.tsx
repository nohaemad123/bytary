...
export default function StoreRegister() {
    ...
    return (
        <>
            <Banner title="Pet store Sign Up" />
            <BreadcrumbComponent title="Pet store Sign Up" />

            <div className="py-10">
                <div className="max-w-screen-md mx-auto px-4">
                    <div className="form border border-gray-300 rounded-md shadow-md p-4">
                        <h3 className="border-b-2 border-primary-600  mb-5 inline-block pb-3 w-fit text-lg font-medium">Pet store Sign Up</h3>
                    ...
                    ${isTouched && error
                                    ...
                                    <div className="flex flex-col gap-y-2">
                                        <div className="flex justify-between">
                                            ...
                                            <div className="flex-col gap-y-2 flex">
                                                <label className="text-white font-bold ">Commerical register</label>
                                                <div className="flex ">
                                                    <label
                                                        htmlFor="dropzone-file"
                                                        className="flex h-25  w-25 cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-primary-600 bg-gray-50 "
