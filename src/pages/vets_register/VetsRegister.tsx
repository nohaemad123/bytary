...
export default function VetRegister() {
    ...
    return (
        <>
            <Banner title="Vet Sign Up" />
            <BreadcrumbComponent title="Vet Sign Up" />

            <div className="py-10">
                <div className="max-w-screen-md mx-auto px-4">
                    <div className="form border border-gray-300 rounded-md shadow-md p-4">
                        <h3 className="border-b-2 border-primary-600  mb-5 inline-block pb-3 w-fit text-lg font-medium">Vet Sign Up</h3>
                            ...
                            >
                                <div className="flex flex-col gap-y-3">
                                    <div className="flex flex-col gap-y-2">
                                        <label className="text-white font-bold">Vet name</label>
                    ...
                    ${isTouched && error
                                    ...
                                    <div className="flex flex-col gap-y-2">
                                        <label className="text-white font-bold">Specification</label>
                                        <div className="relative">
                                            <div className="absolute flex justify-center items-center w-7 border-r border-gray-200 h-full">
                                                <FontAwesomeIcon icon={faUserMd} />
                                            </div>
                                            <input type="text" placeholder="Specification" className={`w-full rounded-sm pl-9 text-sm border-2 rounded-sm
                                            ...
                                            {formik.touched.specification && formik.errors.specification && (
                                                <div className="absolute right-2 top-0 h-full flex justify-center items-center">
                                                    <Tooltip content={formik.errors.specification} placement="top" className="text-xs whitespace-nowrap">
                                                        <a href="#" className="">
                                                            <FontAwesomeIcon icon={faQuestion} className="text-primary-700 blink-icon" />
                                                        </a>
                                                    </Tooltip>
                                    ...
                                    <div className="flex flex-col gap-y-2">
                                        <div className="flex justify-between">
                                            <div className="flex-col gap-y-2 flex">
                                                <label className="text-white font-bold">Personal image</label>
                                                <div className="flex ">
                                                    <label
                                    ...
                                    <div className="flex flex-col gap-y-2">
                                        <div className="flex justify-between">
                                            <div className="flex-col gap-y-2 flex">
                                                <label className="text-white font-bold">University degree</label>
                                                <div className="flex ">
                                                    <label
                                                        htmlFor="dropzone-file"
                                                        className="flex h-25  w-25 cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-primary-600 bg-gray-50 "
                                                    >
                                                        ...
                                                        <FileInput id="dropzone-file" className="hidden" name="degree" />
                                                    </label>
                                                </div>
                                            </div>
