            ...
            <div className="bg-white overflow-hidden flex">
                <div className="grid grid-cols-12 gap-x-10 gap-y-5 pb-2 border-gray-200 w-full">
                    ...
                    <div className="col-span-12 md:col-span-4 border-r border-gray-200">
                        ...
                        <div className="h-[788px] overflow-y-auto border-t border-gray-200">
                    ...
                    <div className="col-span-12 md:col-span-8">
                        ...
                        <div className="h-[590px]  overflow-y-auto p-4 space-y-3 bg-gray-50">
              ...
              border-r-[7px] border-r-gray-200">
                                    ...
                                    hiiiiiiiii
                                    <div className="text-xs text-gray-500 mt-1 text-right">Today At 8:53 PM</div>
                                </div>
                            </div>
              ...
              border-l-[7px] border-l-blue-700">
                                    ...
                                    hiiiiiii
                                    <div className="text-xs text-gray-200 mt-1 text-right">Today At 8:53 PM</div>
                                </div>
                        ...
                        <div className="bg-gray-100 p-4 flex gap-3 items-center">
                            ...
                            <input
                                ...
                                className="flex-1 p-3 rounded border text-gray-500 border-gray-300 focus:outline-none"
                            />
