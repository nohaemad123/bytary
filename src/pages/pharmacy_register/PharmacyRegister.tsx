...
export default function PharmacyRegister() {
    ...
    return (
        <>
            <Banner title="Pharmacy Sign Up" />
            <BreadcrumbComponent title="Pharmacy Sign Up" />

            <div className="py-10">
                <div className="max-w-screen-md mx-auto px-4">
                    <div className="form border border-gray-300 rounded-md shadow-md p-4">
                        <h3 className="border-b-2 border-primary-600  mb-5 inline-block pb-3 w-fit text-lg font-medium">Pharmacy Sign Up</h3>
